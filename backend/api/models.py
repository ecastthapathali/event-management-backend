...
class EventReg(models.Model):
    ...
    participant_id = models.OneToOneField(UserData,on_delete=models.CASCADE)
...
class Participants(models.Model):
    ...
    def __str__(self):
        return f" Name : {self.event_reg.participant_id.name} Event : {self.event_reg.event_id.event_name}"
...
class DigitalCertificate(models.Model):
    ...
    def __str__(self):
        return self.cert_id.event_reg.participant_id.name